...
namespace AT_Utils
{
    public partial class SwitchableTankManager
    {
        ...
        private Rect eWindowPos =
            new Rect(Screen.width / 2 - scroll_width / 2, scroll_height, scroll_width, scroll_height);
        ...
        private void add_tank_gui()
        {
            ...
            selected_tank_type = Utils.LeftRightChooser(selected_tank_type,
                SupportedTypes,
                SwitchableTankType.GetTankTypeInfo(selected_tank_type),
                160);
            ...
            GUILayout.BeginHorizontal();
            if(!volume_valid)
                GUILayout.Label("Volume should be a number.", Styles.danger);
            GUILayout.EndHorizontal();
        ...
        private void volume_configs_gui()
        {
            ...
            config_name = Utils.LeftRightChooser(config_name,
                              VolumeConfigsLibrary.UserConfigs,
                              "Select tank configuration to edit",
                              200)
                          ?? "";
        ...
        /// <param name="onAddTank">
        ///     This function should take selected tank type and value,
        ///     check them and if appropriate add new tank by calling AddTank method.
        /// </param>
        /// <param name="onRemoveTank">
        ///     This function should take selected tank
        ///     and if possible remove it using RemoveTank method.
        /// </param>
        public void DrawTanksManagerWindow(
            int windowId,
            string title,
        ...
        {
            private static readonly GUIContent fill_tank_gui_content =
                new GUIContent("F", "Fill the tank with the resource");
            ...
            private void tank_type_gui()
            {
                ...
                {
                    GUILayout.Label(Tank.TankType, Styles.boxed_label, GUILayout.Width(170));
                }
            }
